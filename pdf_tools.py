...
# --- 1. LOSSLESS/LOSSY COMPRESS QUANTIZATION ENGINE ---
def advanced_compress_quantization_engine(in_path, level, out_path):
    ...
    for page in reader.pages:
        page.compress_content_streams() # Deflates text streams
...
# --- 2. MULTI-MODE DEFLATE SPLIT ENGINE ---
...
# --- 3. CONTAINER TRANSFORMATION MERGE ENGINE ---
